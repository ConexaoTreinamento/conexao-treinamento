...
import { Users, Calendar, Activity, TrendingUp, Clock, AlertTriangle, Plus, UserCheck, CalendarDays } from 'lucide-react'
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-between sm:items-center sm:space-y-0 gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              Bem-vindo, {userName}! Aqui está um resumo das atividades de hoje.
            </p>
          </div>
          ...
          {userRole === "admin" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Alunos com planos que precisam de renovação
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                {expiredPlans.map((student, index) => (
