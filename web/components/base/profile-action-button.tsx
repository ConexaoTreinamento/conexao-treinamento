...
export const PROFILE_ACTION_BUTTON_BASE_CLASSES = "w-full justify-center gap-2 text-sm font-medium"

export interface ProfileActionButtonProps extends ButtonProps {
  fullWidthOnDesktop?: boolean
}

export const ProfileActionButton = forwardRef<HTMLButtonElement, ProfileActionButtonProps>(
  ({
    className,
    size = "default",
    type = "button",
