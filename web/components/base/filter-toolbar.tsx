          ...
          <Sheet open={isOpen} onOpenChange={handleOpenChange}>
            <SheetTrigger asChild>
              <Button
                type="button"
                variant="outline"
                className="relative w-full bg-transparent sm:w-auto"
              >
                ...
                {activeFilterCount > 0 ? (
                  <Badge
                    ...
                    aria-label={`Existem ${activeFilterCount} filtros ativos`}
                  >
                    {activeFilterCount}
                  </Badge>
                ) : null}
            ...
            <SheetContent className="w-full sm:max-w-md">
              ...
              <div className="mt-6 space-y-6">{renderFilters?.({ close })}</div>
            </SheetContent>
          </Sheet>
        ) : null}
      </div>
