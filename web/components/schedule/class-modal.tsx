    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-sm max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Aula avulsa para o dia selecionado
          </DialogDescription>
        </DialogHeader>
        <div className="space-y-4 mt-4">
              ...
              render={({ field }) => (
                <Select value={field.value} onValueChange={field.onChange}>
                  <SelectTrigger>
                    <SelectValue
                      placeholder={
                        trainersQuery.isLoading ? "Carregando..." : "Selecione"
                      }
                    />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="p-3 border rounded-lg space-y-2">
              ...
              {startTime && endTime && endTime < startTime && (
                <p className="text-xs text-red-500">
                  Horário final deve ser após o inicial.
                </p>
              )}
            </div>
          </div>
          <div className="flex gap-2 pt-2">
            ...
            <Button
              ...
              disabled={!isValid || trainersQuery.isLoading}
              className="bg-green-600 hover:bg-green-700 flex-1 disabled:opacity-60"
            >
