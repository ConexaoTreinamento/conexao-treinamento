...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, delete_, findById, update, delete1, findById1, patch, update1, deleteEvent, findEventById, patchEvent, updateEvent, delete2, findById2, patch1, update2, getAllUsersSimple, createUser, findAllTrainers, createTrainerAndUser, findAll, create, findAll1, create1, findAllEvents, createEvent, logout, login, findAll2, create2, patch2, restore, restore1, restoreEvent, restore2 } from '../sdk.gen';
...
import type { SoftDeleteTrainerUserData, FindTrainerByIdData, UpdateTrainerAndUserData, UpdateTrainerAndUserResponse, DeleteData, FindByIdData, UpdateData, UpdateResponse, Delete1Data, FindById1Data, PatchData, PatchResponse, Update1Data, Update1Response, DeleteEventData, FindEventByIdData, PatchEventData, PatchEventResponse, UpdateEventData, UpdateEventResponse, Delete2Data, FindById2Data, Patch1Data, Patch1Response, Update2Data, Update2Response, GetAllUsersSimpleData, GetAllUsersSimpleResponse, CreateUserData, CreateUserResponse, FindAllTrainersData, CreateTrainerAndUserData, CreateTrainerAndUserResponse, FindAllData, FindAllResponse, CreateData, CreateResponse, FindAll1Data, FindAll1Response, Create1Data, Create1Response, FindAllEventsData, FindAllEventsResponse, CreateEventData, CreateEventResponse, LogoutData, LogoutResponse, LoginData, LoginResponse, FindAll2Data, FindAll2Response, Create2Data, Create2Response, Patch2Data, Patch2Response, RestoreData, RestoreResponse, Restore1Data, Restore1Response, RestoreEventData, RestoreEventResponse, Restore2Data, Restore2Response } from '../types.gen';
...
export const findAllEventsInfiniteQueryKey = (options: Options<FindAllEventsData>): QueryKey<Options<FindAllEventsData>> => createQueryKey('findAllEvents', options, true);

export const findAllEventsInfiniteOptions = (options: Options<FindAllEventsData>) => {
    return infiniteQueryOptions<FindAllEventsResponse, DefaultError, InfiniteData<FindAllEventsResponse>, QueryKey<Options<FindAllEventsData>>, number | Pick<QueryKey<Options<FindAllEventsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            // @ts-ignore
            const page: Pick<QueryKey<Options<FindAllEventsData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    'pageable.page': pageParam
                }
            };
        ...
        queryKey: findAllEventsInfiniteQueryKey(options)
    });
};
