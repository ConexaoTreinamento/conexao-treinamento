...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, deleteSchedule, getScheduleById, updateSchedule, deleteEvaluation, getEvaluation, updateEvaluation, deleteStudent, findStudentById, updateStudent, deleteExercise, findExerciseById, patchExercise, updateExercise, deleteEvent, findEventById, patchEvent, updateEvent, softDeleteAdministratorUser, findAdministratorById, patchAdministrator, updateAdministratorAndUser, getAllUsersSimple, createUser, changeOwnPassword, findAllTrainers, createTrainerAndUser, getAllSchedules, createSchedule, findAllStudents, createStudent, getAllEvaluations, createEvaluation, getSession, updateSession, updateSessionTrainer, addSessionParticipant, updatePresence, addRegisteredParticipantExercise, cancelOrRestoreSession, createOneOffSession, getAllPlans, createPlan, restorePlan, assignPlanToStudent, findAllExercises, createExercise, findAllEvents, createEvent, removeParticipant, addParticipant, updateCommitment, bulkUpdateCommitments, logout, login, findAllAdministrators, createAdministratorAndUser, patch, restoreTrainer, resetPassword, restoreStudent, removeRegisteredParticipantExercise, updateRegisteredParticipantExercise, restoreExercise, restoreEvent, toggleAttendance, restoreAdministrator, findTrainerByUserId, getSchedulesByTrainer, getSchedule, getReports, deletePlan, getPlanById, getStudentPlanHistory, getCurrentStudentPlan, getExpiringSoonAssignments, getAllActiveAssignments, getTrainersForLookup, getStudentsForLookup, getStudentCommitments, getCurrentCommitmentStatus, getCommitmentHistory, getCurrentActiveCommitments, getSessionSeriesCommitments, getAvailableSessionSeries, findAdministratorByUserId, test, findAllPaginated, removeSessionParticipant } from '../sdk.gen';
...
import type { SoftDeleteTrainerUserData, FindTrainerByIdData, UpdateTrainerAndUserData, UpdateTrainerAndUserResponse, DeleteScheduleData, GetScheduleByIdData, UpdateScheduleData, UpdateScheduleResponse, DeleteEvaluationData, GetEvaluationData, UpdateEvaluationData, UpdateEvaluationResponse, DeleteStudentData, FindStudentByIdData, UpdateStudentData, UpdateStudentResponse, DeleteExerciseData, FindExerciseByIdData, PatchExerciseData, PatchExerciseResponse, UpdateExerciseData, UpdateExerciseResponse, DeleteEventData, FindEventByIdData, PatchEventData, PatchEventResponse, UpdateEventData, UpdateEventResponse, SoftDeleteAdministratorUserData, FindAdministratorByIdData, PatchAdministratorData, PatchAdministratorResponse, UpdateAdministratorAndUserData, UpdateAdministratorAndUserResponse, GetAllUsersSimpleData, GetAllUsersSimpleResponse, CreateUserData, CreateUserResponse, ChangeOwnPasswordData, FindAllTrainersData, CreateTrainerAndUserData, CreateTrainerAndUserResponse, GetAllSchedulesData, CreateScheduleData, CreateScheduleResponse, FindAllStudentsData, FindAllStudentsResponse, CreateStudentData, CreateStudentResponse, GetAllEvaluationsData, CreateEvaluationData, CreateEvaluationResponse, GetSessionData, UpdateSessionData, UpdateSessionResponse, UpdateSessionTrainerData, UpdateSessionTrainerResponse, AddSessionParticipantData, AddSessionParticipantResponse, UpdatePresenceData, UpdatePresenceResponse, AddRegisteredParticipantExerciseData, AddRegisteredParticipantExerciseResponse, CancelOrRestoreSessionData, CancelOrRestoreSessionResponse, CreateOneOffSessionData, CreateOneOffSessionResponse, GetAllPlansData, CreatePlanData, CreatePlanResponse, RestorePlanData, RestorePlanResponse, AssignPlanToStudentData, AssignPlanToStudentResponse, FindAllExercisesData, FindAllExercisesResponse, CreateExerciseData, CreateExerciseResponse, FindAllEventsData, CreateEventData, CreateEventResponse, RemoveParticipantData, AddParticipantData, AddParticipantResponse, UpdateCommitmentData, UpdateCommitmentResponse, BulkUpdateCommitmentsData, BulkUpdateCommitmentsResponse, LogoutData, LogoutResponse, LoginData, LoginResponse, FindAllAdministratorsData, CreateAdministratorAndUserData, CreateAdministratorAndUserResponse, PatchData, PatchResponse, RestoreTrainerData, RestoreTrainerResponse, ResetPasswordData, RestoreStudentData, RestoreStudentResponse, RemoveRegisteredParticipantExerciseData, RemoveRegisteredParticipantExerciseResponse, UpdateRegisteredParticipantExerciseData, UpdateRegisteredParticipantExerciseResponse, RestoreExerciseData, RestoreExerciseResponse, RestoreEventData, RestoreEventResponse, ToggleAttendanceData, ToggleAttendanceResponse, RestoreAdministratorData, RestoreAdministratorResponse, FindTrainerByUserIdData, GetSchedulesByTrainerData, GetScheduleData, GetReportsData, DeletePlanData, GetPlanByIdData, GetStudentPlanHistoryData, GetCurrentStudentPlanData, GetExpiringSoonAssignmentsData, GetAllActiveAssignmentsData, GetTrainersForLookupData, GetStudentsForLookupData, GetStudentCommitmentsData, GetCurrentCommitmentStatusData, GetCommitmentHistoryData, GetCurrentActiveCommitmentsData, GetSessionSeriesCommitmentsData, GetAvailableSessionSeriesData, FindAdministratorByUserIdData, TestData, FindAllPaginatedData, FindAllPaginatedResponse, RemoveSessionParticipantData, RemoveSessionParticipantResponse } from '../types.gen';
