...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, deleteEvaluation, getEvaluation, updateEvaluation, deleteStudent, findStudentById, updateStudent, deleteSchedule, getScheduleById, updateSchedule, deleteExercise, findExerciseById, patchExercise, updateExercise, deleteEvent, findEventById, patchEvent, updateEvent, findAdministratorById, updateAdministrator, getAllUsersSimple, createUser, changeOwnPassword, findAllTrainers, createTrainerAndUser, getSchedulesByTrainer, createSchedule, findAllStudents, createStudent, getAllEvaluations, createEvaluation, updateCommitment, bulkUpdateCommitments, getSchedule, createOneOffSession, addSessionParticipant, addRegisteredParticipantExercise, getAllPlans, createPlan, restorePlan, getStudentPlanHistory, assignPlanToStudent, findAllExercises, createExercise, findAllEvents, createEvent, removeParticipant, addParticipant, logout, login, findAllAdministrators, createAdministrator, patch, restoreTrainer, resetPassword, restoreStudent, getSession, updateSession, updateSessionTrainer, updatePresence, cancelOrRestoreSession, removeRegisteredParticipantExercise, updateRegisteredParticipantExercise, restoreExercise, restoreEvent, toggleAttendance, deleteAdministrator, patchAdministrator, restoreAdministrator, findTrainerByUserId, getStudentCommitments, getCurrentCommitmentStatus, getCommitmentHistory, getCurrentActiveCommitments, getAllSchedules, getSessionSeriesCommitments, getReports, deletePlan, getPlanById, getCurrentStudentPlan, getExpiringSoonAssignments, getAllActiveAssignments, getTrainersForLookup, getStudentsForLookup, getAvailableSessionSeries, findAdministratorByUserId, findAllPaginated, removeSessionParticipant } from '../sdk.gen';
...
import type { SoftDeleteTrainerUserData, FindTrainerByIdData, UpdateTrainerAndUserData, UpdateTrainerAndUserResponse, DeleteEvaluationData, GetEvaluationData, UpdateEvaluationData, UpdateEvaluationResponse, DeleteStudentData, FindStudentByIdData, UpdateStudentData, UpdateStudentResponse, DeleteScheduleData, GetScheduleByIdData, UpdateScheduleData, UpdateScheduleResponse, DeleteExerciseData, FindExerciseByIdData, PatchExerciseData, PatchExerciseResponse, UpdateExerciseData, UpdateExerciseResponse, DeleteEventData, FindEventByIdData, PatchEventData, PatchEventResponse, UpdateEventData, UpdateEventResponse, FindAdministratorByIdData, UpdateAdministratorData, UpdateAdministratorResponse, GetAllUsersSimpleData, GetAllUsersSimpleResponse, CreateUserData, CreateUserResponse, ChangeOwnPasswordData, FindAllTrainersData, CreateTrainerAndUserData, CreateTrainerAndUserResponse, GetSchedulesByTrainerData, CreateScheduleData, CreateScheduleResponse, FindAllStudentsData, FindAllStudentsResponse, CreateStudentData, CreateStudentResponse, GetAllEvaluationsData, CreateEvaluationData, CreateEvaluationResponse, UpdateCommitmentData, UpdateCommitmentResponse, BulkUpdateCommitmentsData, BulkUpdateCommitmentsResponse, GetScheduleData, CreateOneOffSessionData, CreateOneOffSessionResponse, AddSessionParticipantData, AddSessionParticipantResponse, AddRegisteredParticipantExerciseData, AddRegisteredParticipantExerciseResponse, GetAllPlansData, CreatePlanData, CreatePlanResponse, RestorePlanData, RestorePlanResponse, GetStudentPlanHistoryData, AssignPlanToStudentData, AssignPlanToStudentResponse, FindAllExercisesData, FindAllExercisesResponse, CreateExerciseData, CreateExerciseResponse, FindAllEventsData, CreateEventData, CreateEventResponse, RemoveParticipantData, AddParticipantData, AddParticipantResponse, LogoutData, LogoutResponse, LoginData, LoginResponse, FindAllAdministratorsData, CreateAdministratorData, CreateAdministratorResponse, PatchData, PatchResponse, RestoreTrainerData, RestoreTrainerResponse, ResetPasswordData, RestoreStudentData, RestoreStudentResponse, GetSessionData, UpdateSessionData, UpdateSessionResponse, UpdateSessionTrainerData, UpdateSessionTrainerResponse, UpdatePresenceData, UpdatePresenceResponse, CancelOrRestoreSessionData, CancelOrRestoreSessionResponse, RemoveRegisteredParticipantExerciseData, RemoveRegisteredParticipantExerciseResponse, UpdateRegisteredParticipantExerciseData, UpdateRegisteredParticipantExerciseResponse, RestoreExerciseData, RestoreExerciseResponse, RestoreEventData, RestoreEventResponse, ToggleAttendanceData, ToggleAttendanceResponse, DeleteAdministratorData, PatchAdministratorData, PatchAdministratorResponse, RestoreAdministratorData, RestoreAdministratorResponse, FindTrainerByUserIdData, GetStudentCommitmentsData, GetCurrentCommitmentStatusData, GetCommitmentHistoryData, GetCurrentActiveCommitmentsData, GetAllSchedulesData, GetSessionSeriesCommitmentsData, GetReportsData, DeletePlanData, GetPlanByIdData, GetCurrentStudentPlanData, GetExpiringSoonAssignmentsData, GetAllActiveAssignmentsData, GetTrainersForLookupData, GetStudentsForLookupData, GetAvailableSessionSeriesData, FindAdministratorByUserIdData, FindAllPaginatedData, FindAllPaginatedResponse, RemoveSessionParticipantData } from '../types.gen';
...
export const deleteEvaluationMutation = (options?: Partial<Options<DeleteEvaluationData>>): UseMutationOptions<unknown, DefaultError, Options<DeleteEvaluationData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DeleteEvaluationData>> = {
        mutationFn: async (localOptions) => {
...
export const updateEvaluationMutation = (options?: Partial<Options<UpdateEvaluationData>>): UseMutationOptions<UpdateEvaluationResponse, DefaultError, Options<UpdateEvaluationData>> => {
    const mutationOptions: UseMutationOptions<UpdateEvaluationResponse, DefaultError, Options<UpdateEvaluationData>> = {
        mutationFn: async (localOptions) => {
    ...
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            ...
            const page: Pick<QueryKey<Options<GetAllUsersSimpleData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    // @ts-expect-error generated code uses 'pageable.page' but TS infers 'pageable.page' does not exist on type
...
export const changeOwnPasswordMutation = (options?: Partial<Options<ChangeOwnPasswordData>>): UseMutationOptions<unknown, DefaultError, Options<ChangeOwnPasswordData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<ChangeOwnPasswordData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await changeOwnPassword({
                ...options,
                ...localOptions,
...
export const createEvaluationMutation = (options?: Partial<Options<CreateEvaluationData>>): UseMutationOptions<CreateEvaluationResponse, DefaultError, Options<CreateEvaluationData>> => {
    const mutationOptions: UseMutationOptions<CreateEvaluationResponse, DefaultError, Options<CreateEvaluationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createEvaluation({
                ...options,
                ...localOptions,
...
export const restorePlanMutation = (options?: Partial<Options<RestorePlanData>>): UseMutationOptions<RestorePlanResponse, DefaultError, Options<RestorePlanData>> => {
    const mutationOptions: UseMutationOptions<RestorePlanResponse, DefaultError, Options<RestorePlanData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await restorePlan({
                ...options,
                ...localOptions,
...
export const restoreTrainerMutation = (options?: Partial<Options<RestoreTrainerData>>): UseMutationOptions<RestoreTrainerResponse, DefaultError, Options<RestoreTrainerData>> => {
    const mutationOptions: UseMutationOptions<RestoreTrainerResponse, DefaultError, Options<RestoreTrainerData>> = {
        mutationFn: async (localOptions) => {
...
export const removeSessionParticipantMutation = (options?: Partial<Options<RemoveSessionParticipantData>>): UseMutationOptions<unknown, DefaultError, Options<RemoveSessionParticipantData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<RemoveSessionParticipantData>> = {
        mutationFn: async (localOptions) => {
