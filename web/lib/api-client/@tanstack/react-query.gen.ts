...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, delete_, findById, update, delete1, findById1, patch, update1, updateSchedule, delete2, findById2, patch1, update2, getAllUsersSimple, createUser, findAllTrainers, createTrainerAndUser, findAll, create, findAll1, create1, logout, login, updateSession, createOneOffSession, enrollStudent, getAllPlans, createPlan, assignPlanToStudent, splitCommitment, createCommitment, findAll2, create2, patch2, restore, restore1, restore2, getSchedule, deletePlan, getPlanById, getStudentPlanHistory, getCurrentStudentPlan, getExpiringSoonAssignments, getAllActiveAssignments, getCommitmentsAt } from '../sdk.gen';
...
import type { SoftDeleteTrainerUserData, FindTrainerByIdData, UpdateTrainerAndUserData, UpdateTrainerAndUserResponse, DeleteData, FindByIdData, UpdateData, UpdateResponse, Delete1Data, FindById1Data, PatchData, PatchResponse, Update1Data, Update1Response, UpdateScheduleData, UpdateScheduleResponse, Delete2Data, FindById2Data, Patch1Data, Patch1Response, Update2Data, Update2Response, GetAllUsersSimpleData, GetAllUsersSimpleResponse, CreateUserData, CreateUserResponse, FindAllTrainersData, CreateTrainerAndUserData, CreateTrainerAndUserResponse, FindAllData, FindAllResponse, CreateData, CreateResponse, FindAll1Data, FindAll1Response, Create1Data, Create1Response, LogoutData, LogoutResponse, LoginData, LoginResponse, UpdateSessionData, UpdateSessionResponse, CreateOneOffSessionData, CreateOneOffSessionResponse, EnrollStudentData, EnrollStudentResponse, GetAllPlansData, CreatePlanData, CreatePlanResponse, AssignPlanToStudentData, AssignPlanToStudentResponse, SplitCommitmentData, SplitCommitmentResponse, CreateCommitmentData, CreateCommitmentResponse, FindAll2Data, FindAll2Response, Create2Data, Create2Response, Patch2Data, Patch2Response, RestoreData, RestoreResponse, Restore1Data, Restore1Response, Restore2Data, Restore2Response, GetScheduleData, DeletePlanData, GetPlanByIdData, GetStudentPlanHistoryData, GetCurrentStudentPlanData, GetExpiringSoonAssignmentsData, GetAllActiveAssignmentsData, GetCommitmentsAtData } from '../types.gen';
