...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, delete_, findById, update, delete1, findById1, patch, update1, delete2, findById2, patch1, update2, getAllUsersSimple, createUser, findAllTrainers, createTrainerAndUser, findAll, create, findAll1, create1, logout, login, findAll2, create2, patch2, restore, restore1, restore2 } from '../sdk.gen';
