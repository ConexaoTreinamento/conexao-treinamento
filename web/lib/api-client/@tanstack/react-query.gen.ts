...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, deleteSchedule, getScheduleById, updateSchedule, deleteStudent, findStudentById, updateStudent, deleteExercise, findExerciseById, patchExercise, updateExercise, deleteAdministrator, findAdministratorById, patchAdministrator, updateAdministrator, getAllUsersSimple, createUser, findAllTrainers, createTrainerAndUser, getAllSchedules, createSchedule, findAllStudents, createStudent, updateSession, getAllPlans, createPlan, assignPlanToStudent, findAllExercises, createExercise, updateCommitment, bulkUpdateCommitments, logout, login, findAllAdministrators, createAdministrator, patch, restoreStudent, restoreExercise, restoreAdministrator, findTrainerByUserId, getSchedulesByTrainer, getSchedule, deletePlan, getPlanById, getStudentPlanHistory, getCurrentStudentPlan, getExpiringSoonAssignments, getAllActiveAssignments, getStudentCommitments, getCurrentCommitmentStatus, getCommitmentHistory, getCurrentActiveCommitments, getSessionSeriesCommitments, getAvailableSessionSeries } from '../sdk.gen';
