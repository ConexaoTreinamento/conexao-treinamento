...
import { type Options, login, logout, getAllUsersSimple, createUser, changeOwnPassword, patchUser, findAllAdministrators, createAdministrator, deleteAdministrator, findAdministratorById, patchAdministrator, updateAdministrator, restoreAdministrator, findAdministratorByUserId, findAllPaginated, testEndpoint, findAllTrainers, createTrainer, deleteTrainer, findTrainerById, updateTrainer, deleteSchedule, getScheduleById, updateSchedule, getSchedulesByTrainer, createSchedule, getSchedule, createOneOffSession, deleteEvaluation, getEvaluation, updateEvaluation, deleteStudent, findStudentById, updateStudent, restoreStudent, findAllExercises, createExercise, deleteExercise, findExerciseById, patchExercise, updateExercise, findAllEvents, createEvent, deleteEvent, findEventById, patchEvent, updateEvent, getAllSchedules, findAllStudents, createStudent, getAllEvaluations, createEvaluation, getSession, updateSession, updateSessionTrainer, addSessionParticipant, updatePresence, addRegisteredParticipantExercise, removeRegisteredParticipantExercise, updateRegisteredParticipantExercise, cancelOrRestoreSession, getAllPlans, createPlan, deletePlan, getPlanById, getExpiringSoonAssignments, getAllActiveAssignments, removeParticipant, addParticipant, updateCommitment, bulkUpdateCommitments, resetPassword, restoreExercise, restoreEvent, toggleAttendance, findTrainerByUserId, getReports, getStudentPlanHistory, assignPlanToStudent, getCurrentStudentPlan, getTrainersForLookup, getStudentsForLookup, getStudentCommitments, getCurrentCommitmentStatus, getCommitmentHistory, getCurrentActiveCommitments, getSessionSeriesCommitments, getAvailableSessionSeries, removeSessionParticipant } from '../sdk.gen';
...
import type { LoginData, LoginResponse, LogoutData, LogoutResponse, GetAllUsersSimpleData, GetAllUsersSimpleResponse, CreateUserData, CreateUserResponse, ChangeOwnPasswordData, PatchUserData, PatchUserResponse, FindAllAdministratorsData, CreateAdministratorData, CreateAdministratorResponse, DeleteAdministratorData, FindAdministratorByIdData, PatchAdministratorData, PatchAdministratorResponse, UpdateAdministratorData, UpdateAdministratorResponse, RestoreAdministratorData, RestoreAdministratorResponse, FindAdministratorByUserIdData, FindAllPaginatedData, FindAllPaginatedResponse, TestEndpointData, FindAllTrainersData, CreateTrainerData, CreateTrainerResponse, DeleteTrainerData, FindTrainerByIdData, UpdateTrainerData, UpdateTrainerResponse, DeleteScheduleData, GetScheduleByIdData, UpdateScheduleData, UpdateScheduleResponse, GetSchedulesByTrainerData, CreateScheduleData, CreateScheduleResponse, GetScheduleData, CreateOneOffSessionData, CreateOneOffSessionResponse, DeleteEvaluationData, GetEvaluationData, UpdateEvaluationData, UpdateEvaluationResponse, DeleteStudentData, FindStudentByIdData, UpdateStudentData, UpdateStudentResponse, RestoreStudentData, RestoreStudentResponse, FindAllExercisesData, FindAllExercisesResponse, CreateExerciseData, CreateExerciseResponse, DeleteExerciseData, FindExerciseByIdData, PatchExerciseData, PatchExerciseResponse, UpdateExerciseData, UpdateExerciseResponse, FindAllEventsData, CreateEventData, CreateEventResponse, DeleteEventData, FindEventByIdData, PatchEventData, PatchEventResponse, UpdateEventData, UpdateEventResponse, GetAllSchedulesData, FindAllStudentsData, FindAllStudentsResponse, CreateStudentData, CreateStudentResponse, GetAllEvaluationsData, CreateEvaluationData, CreateEvaluationResponse, GetSessionData, UpdateSessionData, UpdateSessionResponse, UpdateSessionTrainerData, UpdateSessionTrainerResponse, AddSessionParticipantData, AddSessionParticipantResponse, UpdatePresenceData, UpdatePresenceResponse, AddRegisteredParticipantExerciseData, AddRegisteredParticipantExerciseResponse, RemoveRegisteredParticipantExerciseData, RemoveRegisteredParticipantExerciseResponse, UpdateRegisteredParticipantExerciseData, UpdateRegisteredParticipantExerciseResponse, CancelOrRestoreSessionData, CancelOrRestoreSessionResponse, GetAllPlansData, CreatePlanData, CreatePlanResponse, DeletePlanData, GetPlanByIdData, GetExpiringSoonAssignmentsData, GetAllActiveAssignmentsData, RemoveParticipantData, AddParticipantData, AddParticipantResponse, UpdateCommitmentData, UpdateCommitmentResponse, BulkUpdateCommitmentsData, BulkUpdateCommitmentsResponse, ResetPasswordData, RestoreExerciseData, RestoreExerciseResponse, RestoreEventData, RestoreEventResponse, ToggleAttendanceData, ToggleAttendanceResponse, FindTrainerByUserIdData, GetReportsData, GetStudentPlanHistoryData, AssignPlanToStudentData, AssignPlanToStudentResponse, GetCurrentStudentPlanData, GetTrainersForLookupData, GetStudentsForLookupData, GetStudentCommitmentsData, GetCurrentCommitmentStatusData, GetCommitmentHistoryData, GetCurrentActiveCommitmentsData, GetSessionSeriesCommitmentsData, GetAvailableSessionSeriesData, RemoveSessionParticipantData, RemoveSessionParticipantResponse } from '../types.gen';
...
export const patchUserMutation = (options?: Partial<Options<PatchUserData>>): UseMutationOptions<PatchUserResponse, DefaultError, Options<PatchUserData>> => {
    const mutationOptions: UseMutationOptions<PatchUserResponse, DefaultError, Options<PatchUserData>> = {
        mutationFn: async (localOptions) => {
...
export const testEndpointQueryKey = (options?: Options<TestEndpointData>) => createQueryKey('testEndpoint', options);

export const testEndpointOptions = (options?: Options<TestEndpointData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: testEndpointQueryKey(options)
    });
};
...
export const createTrainerQueryKey = (options: Options<CreateTrainerData>) => createQueryKey('createTrainer', options);

export const createTrainerOptions = (options: Options<CreateTrainerData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: createTrainerQueryKey(options)
    });
};

export const createTrainerMutation = (options?: Partial<Options<CreateTrainerData>>): UseMutationOptions<CreateTrainerResponse, DefaultError, Options<CreateTrainerData>> => {
    const mutationOptions: UseMutationOptions<CreateTrainerResponse, DefaultError, Options<CreateTrainerData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createTrainer({
                ...options,
                ...localOptions,
...
export const deleteTrainerMutation = (options?: Partial<Options<DeleteTrainerData>>): UseMutationOptions<unknown, DefaultError, Options<DeleteTrainerData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DeleteTrainerData>> = {
        mutationFn: async (localOptions) => {
