...
import type { SoftDeleteTrainerUserData, FindTrainerByIdData, UpdateTrainerAndUserData, UpdateTrainerAndUserResponse, DeleteData, FindByIdData, UpdateData, UpdateResponse, Delete1Data, FindById1Data, PatchData, PatchResponse, Update1Data, Update1Response, UpdateScheduleData, UpdateScheduleResponse, RestorePlanData, Delete2Data, FindById2Data, Patch1Data, Patch1Response, Update2Data, Update2Response, GetAllUsersSimpleData, GetAllUsersSimpleResponse, CreateUserData, CreateUserResponse, FindAllTrainersData, CreateTrainerAndUserData, CreateTrainerAndUserResponse, FindAllData, FindAllResponse, CreateData, CreateResponse, FindAll1Data, FindAll1Response, Create1Data, Create1Response, LogoutData, LogoutResponse, LoginData, LoginResponse, UpdateSessionData, UpdateSessionResponse, GetSeriesData, CreateSeriesData, CreateSeriesResponse, SplitWeekData, SplitWeekResponse, DeactivateWeekdaysData, DeactivateWeekdaysResponse, CreateOneOffSessionData, CreateOneOffSessionResponse, EnrollStudentData, EnrollStudentResponse, GetAllPlansData, CreatePlanData, CreatePlanResponse, AssignPlanToStudentData, AssignPlanToStudentResponse, SplitCommitmentData, SplitCommitmentResponse, CreateCommitmentData, CreateCommitmentResponse, FindAll2Data, FindAll2Response, Create2Data, Create2Response, Patch2Data, Patch2Response, RestoreData, RestoreResponse, Restore1Data, Restore1Response, Restore2Data, Restore2Response, GetScheduleData, DeletePlanData, GetPlanByIdData, GetStudentPlanHistoryData, GetCurrentStudentPlanData, GetExpiringSoonAssignmentsData, GetAllActiveAssignmentsData, GetCommitmentsAtData } from '../types.gen';
    ...
    // @ts-ignore
    {
        queryFn: async ({ pageParam, queryKey, signal }) => {
            ...
            const page: Pick<QueryKey<Options<GetAllUsersSimpleData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
                query: {
                    pageable: { page: pageParam as number }
                } as any
            };
...
export const splitWeekQueryKey = (options: Options<SplitWeekData>) => createQueryKey('splitWeek', options);

export const splitWeekOptions = (options: Options<SplitWeekData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await splitWeek({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: splitWeekQueryKey(options)
    });
};

export const splitWeekMutation = (options?: Partial<Options<SplitWeekData>>): UseMutationOptions<SplitWeekResponse, DefaultError, Options<SplitWeekData>> => {
    const mutationOptions: UseMutationOptions<SplitWeekResponse, DefaultError, Options<SplitWeekData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await splitWeek({
                ...options,
                ...localOptions,
...
export const deactivateWeekdaysQueryKey = (options: Options<DeactivateWeekdaysData>) => createQueryKey('deactivateWeekdays', options);

export const deactivateWeekdaysOptions = (options: Options<DeactivateWeekdaysData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await deactivateWeekdays({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: deactivateWeekdaysQueryKey(options)
    });
};

export const deactivateWeekdaysMutation = (options?: Partial<Options<DeactivateWeekdaysData>>): UseMutationOptions<DeactivateWeekdaysResponse, DefaultError, Options<DeactivateWeekdaysData>> => {
    const mutationOptions: UseMutationOptions<DeactivateWeekdaysResponse, DefaultError, Options<DeactivateWeekdaysData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deactivateWeekdays({
                ...options,
                ...localOptions,
