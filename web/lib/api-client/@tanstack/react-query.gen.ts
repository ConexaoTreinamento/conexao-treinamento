...
import { type Options, softDeleteTrainerUser, findTrainerById, updateTrainerAndUser, deleteSchedule, getScheduleById, updateSchedule, deleteStudent, findStudentById, updateStudent, deleteExercise, findExerciseById, patchExercise, updateExercise, deleteAdministrator, findAdministratorById, patchAdministrator, updateAdministrator, getAllUsersSimple, createUser, findAllTrainers, createTrainerAndUser, getAllSchedules, createSchedule, findAllStudents, createStudent, getSession, updateSession, updateTrainer, addParticipant, updatePresence, addExercise, cancelOrRestore, createOneOff, getAllPlans, createPlan, assignPlanToStudent, findAllExercises, createExercise, updateCommitment, bulkUpdateCommitments, logout, login, findAllAdministrators, createAdministrator, patch, restoreStudent, removeExercise, updateExercise1, restoreExercise, restoreAdministrator, getSchedulesByTrainer, getSchedule, deletePlan, getPlanById, getStudentPlanHistory, getCurrentStudentPlan, getExpiringSoonAssignments, getAllActiveAssignments, getStudentCommitments, getCurrentCommitmentStatus, getCommitmentHistory, getCurrentActiveCommitments, getSessionSeriesCommitments, getAvailableSessionSeries, removeParticipant } from '../sdk.gen';
...
export const updateExercise1Mutation = (options?: Partial<Options<UpdateExercise1Data>>): UseMutationOptions<UpdateExercise1Response, DefaultError, Options<UpdateExercise1Data>> => {
    const mutationOptions: UseMutationOptions<UpdateExercise1Response, DefaultError, Options<UpdateExercise1Data>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updateExercise1({
                ...options,
                ...localOptions,
                throwOnError: true
            });
