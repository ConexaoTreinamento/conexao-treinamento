...
import type { SoftDeleteTrainerUserData, SoftDeleteTrainerUserResponses, FindTrainerByIdData, FindTrainerByIdResponses, UpdateTrainerAndUserData, UpdateTrainerAndUserResponses, DeleteScheduleData, DeleteScheduleResponses, GetScheduleByIdData, GetScheduleByIdResponses, UpdateScheduleData, UpdateScheduleResponses, DeleteStudentData, DeleteStudentResponses, FindStudentByIdData, FindStudentByIdResponses, UpdateStudentData, UpdateStudentResponses, DeleteExerciseData, DeleteExerciseResponses, FindExerciseByIdData, FindExerciseByIdResponses, PatchExerciseData, PatchExerciseResponses, UpdateExerciseData, UpdateExerciseResponses, DeleteAdministratorData, DeleteAdministratorResponses, FindAdministratorByIdData, FindAdministratorByIdResponses, PatchAdministratorData, PatchAdministratorResponses, UpdateAdministratorData, UpdateAdministratorResponses, GetAllUsersSimpleData, GetAllUsersSimpleResponses, CreateUserData, CreateUserResponses, FindAllTrainersData, FindAllTrainersResponses, CreateTrainerAndUserData, CreateTrainerAndUserResponses, GetAllSchedulesData, GetAllSchedulesResponses, CreateScheduleData, CreateScheduleResponses, FindAllStudentsData, FindAllStudentsResponses, CreateStudentData, CreateStudentResponses, GetSessionData, GetSessionResponses, UpdateSessionData, UpdateSessionResponses, UpdateTrainerData, UpdateTrainerResponses, AddParticipantData, AddParticipantResponses, UpdatePresenceData, UpdatePresenceResponses, AddExerciseData, AddExerciseResponses, CancelOrRestoreData, CancelOrRestoreResponses, CreateOneOffData, CreateOneOffResponses, GetAllPlansData, GetAllPlansResponses, CreatePlanData, CreatePlanResponses, AssignPlanToStudentData, AssignPlanToStudentResponses, FindAllExercisesData, FindAllExercisesResponses, CreateExerciseData, CreateExerciseResponses, UpdateCommitmentData, UpdateCommitmentResponses, BulkUpdateCommitmentsData, BulkUpdateCommitmentsResponses, LogoutData, LogoutResponses, LoginData, LoginResponses, FindAllAdministratorsData, FindAllAdministratorsResponses, CreateAdministratorData, CreateAdministratorResponses, PatchData, PatchResponses, RestoreStudentData, RestoreStudentResponses, RemoveExerciseData, RemoveExerciseResponses, UpdateExercise1Data, UpdateExercise1Responses, RestoreExerciseData, RestoreExerciseResponses, RestoreAdministratorData, RestoreAdministratorResponses, GetSchedulesByTrainerData, GetSchedulesByTrainerResponses, GetScheduleData, GetScheduleResponses, DeletePlanData, DeletePlanResponses, GetPlanByIdData, GetPlanByIdResponses, GetStudentPlanHistoryData, GetStudentPlanHistoryResponses, GetCurrentStudentPlanData, GetCurrentStudentPlanResponses, GetExpiringSoonAssignmentsData, GetExpiringSoonAssignmentsResponses, GetAllActiveAssignmentsData, GetAllActiveAssignmentsResponses, GetStudentCommitmentsData, GetStudentCommitmentsResponses, GetCurrentCommitmentStatusData, GetCurrentCommitmentStatusResponses, GetCommitmentHistoryData, GetCommitmentHistoryResponses, GetCurrentActiveCommitmentsData, GetCurrentActiveCommitmentsResponses, GetSessionSeriesCommitmentsData, GetSessionSeriesCommitmentsResponses, GetAvailableSessionSeriesData, GetAvailableSessionSeriesResponses, RemoveParticipantData, RemoveParticipantResponses } from './types.gen';
...
export const updateTrainer = <ThrowOnError extends boolean = false>(options: Options<UpdateTrainerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UpdateTrainerResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const addExercise = <ThrowOnError extends boolean = false>(options: Options<AddExerciseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AddExerciseResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const cancelOrRestore = <ThrowOnError extends boolean = false>(options: Options<CancelOrRestoreData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CancelOrRestoreResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const createOneOff = <ThrowOnError extends boolean = false>(options: Options<CreateOneOffData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateOneOffResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const removeExercise = <ThrowOnError extends boolean = false>(options: Options<RemoveExerciseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<RemoveExerciseResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const updateExercise1 = <ThrowOnError extends boolean = false>(options: Options<UpdateExercise1Data, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateExercise1Responses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
