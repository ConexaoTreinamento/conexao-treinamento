...
import type { SoftDeleteTrainerUserData, SoftDeleteTrainerUserResponses, FindTrainerByIdData, FindTrainerByIdResponses, UpdateTrainerAndUserData, UpdateTrainerAndUserResponses, DeleteData, DeleteResponses, FindByIdData, FindByIdResponses, UpdateData, UpdateResponses, Delete1Data, Delete1Responses, FindById1Data, FindById1Responses, PatchData, PatchResponses, Update1Data, Update1Responses, UpdateScheduleData, UpdateScheduleResponses, RestorePlanData, RestorePlanResponses, Delete2Data, Delete2Responses, FindById2Data, FindById2Responses, Patch1Data, Patch1Responses, Update2Data, Update2Responses, GetAllUsersSimpleData, GetAllUsersSimpleResponses, CreateUserData, CreateUserResponses, FindAllTrainersData, FindAllTrainersResponses, CreateTrainerAndUserData, CreateTrainerAndUserResponses, FindAllData, FindAllResponses, CreateData, CreateResponses, FindAll1Data, FindAll1Responses, Create1Data, Create1Responses, LogoutData, LogoutResponses, LoginData, LoginResponses, UpdateSessionData, UpdateSessionResponses, GetSeriesData, GetSeriesResponses, CreateSeriesData, CreateSeriesResponses, SplitWeekData, SplitWeekResponses, DeactivateWeekdaysData, DeactivateWeekdaysResponses, CreateOneOffSessionData, CreateOneOffSessionResponses, EnrollStudentData, EnrollStudentResponses, GetAllPlansData, GetAllPlansResponses, CreatePlanData, CreatePlanResponses, AssignPlanToStudentData, AssignPlanToStudentResponses, SplitCommitmentData, SplitCommitmentResponses, CreateCommitmentData, CreateCommitmentResponses, FindAll2Data, FindAll2Responses, Create2Data, Create2Responses, Patch2Data, Patch2Responses, RestoreData, RestoreResponses, Restore1Data, Restore1Responses, Restore2Data, Restore2Responses, GetScheduleData, GetScheduleResponses, DeletePlanData, DeletePlanResponses, GetPlanByIdData, GetPlanByIdResponses, GetStudentPlanHistoryData, GetStudentPlanHistoryResponses, GetCurrentStudentPlanData, GetCurrentStudentPlanResponses, GetExpiringSoonAssignmentsData, GetExpiringSoonAssignmentsResponses, GetAllActiveAssignmentsData, GetAllActiveAssignmentsResponses, GetCommitmentsAtData, GetCommitmentsAtResponses } from './types.gen';
...
export const splitWeek = <ThrowOnError extends boolean = false>(options: Options<SplitWeekData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<SplitWeekResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const deactivateWeekdays = <ThrowOnError extends boolean = false>(options: Options<DeactivateWeekdaysData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<DeactivateWeekdaysResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
