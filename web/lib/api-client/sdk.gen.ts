...
import type { SoftDeleteTrainerUserData, SoftDeleteTrainerUserResponses, FindTrainerByIdData, FindTrainerByIdResponses, UpdateTrainerAndUserData, UpdateTrainerAndUserResponses, DeleteEvaluationData, DeleteEvaluationResponses, GetEvaluationData, GetEvaluationResponses, UpdateEvaluationData, UpdateEvaluationResponses, DeleteStudentData, DeleteStudentResponses, FindStudentByIdData, FindStudentByIdResponses, UpdateStudentData, UpdateStudentResponses, DeleteScheduleData, DeleteScheduleResponses, GetScheduleByIdData, GetScheduleByIdResponses, UpdateScheduleData, UpdateScheduleResponses, DeleteExerciseData, DeleteExerciseResponses, FindExerciseByIdData, FindExerciseByIdResponses, PatchExerciseData, PatchExerciseResponses, UpdateExerciseData, UpdateExerciseResponses, DeleteEventData, DeleteEventResponses, FindEventByIdData, FindEventByIdResponses, PatchEventData, PatchEventResponses, UpdateEventData, UpdateEventResponses, FindAdministratorByIdData, FindAdministratorByIdResponses, UpdateAdministratorData, UpdateAdministratorResponses, GetAllUsersSimpleData, GetAllUsersSimpleResponses, CreateUserData, CreateUserResponses, ChangeOwnPasswordData, ChangeOwnPasswordResponses, FindAllTrainersData, FindAllTrainersResponses, CreateTrainerAndUserData, CreateTrainerAndUserResponses, GetSchedulesByTrainerData, GetSchedulesByTrainerResponses, CreateScheduleData, CreateScheduleResponses, FindAllStudentsData, FindAllStudentsResponses, CreateStudentData, CreateStudentResponses, GetAllEvaluationsData, GetAllEvaluationsResponses, CreateEvaluationData, CreateEvaluationResponses, UpdateCommitmentData, UpdateCommitmentResponses, BulkUpdateCommitmentsData, BulkUpdateCommitmentsResponses, GetScheduleData, GetScheduleResponses, CreateOneOffSessionData, CreateOneOffSessionResponses, AddSessionParticipantData, AddSessionParticipantResponses, AddRegisteredParticipantExerciseData, AddRegisteredParticipantExerciseResponses, GetAllPlansData, GetAllPlansResponses, CreatePlanData, CreatePlanResponses, RestorePlanData, RestorePlanResponses, GetStudentPlanHistoryData, GetStudentPlanHistoryResponses, AssignPlanToStudentData, AssignPlanToStudentResponses, FindAllExercisesData, FindAllExercisesResponses, CreateExerciseData, CreateExerciseResponses, FindAllEventsData, FindAllEventsResponses, CreateEventData, CreateEventResponses, RemoveParticipantData, RemoveParticipantResponses, AddParticipantData, AddParticipantResponses, LogoutData, LogoutResponses, LoginData, LoginResponses, FindAllAdministratorsData, FindAllAdministratorsResponses, CreateAdministratorData, CreateAdministratorResponses, PatchData, PatchResponses, RestoreTrainerData, RestoreTrainerResponses, ResetPasswordData, ResetPasswordResponses, RestoreStudentData, RestoreStudentResponses, GetSessionData, GetSessionResponses, UpdateSessionData, UpdateSessionResponses, UpdateSessionTrainerData, UpdateSessionTrainerResponses, UpdatePresenceData, UpdatePresenceResponses, CancelOrRestoreSessionData, CancelOrRestoreSessionResponses, RemoveRegisteredParticipantExerciseData, RemoveRegisteredParticipantExerciseResponses, UpdateRegisteredParticipantExerciseData, UpdateRegisteredParticipantExerciseResponses, RestoreExerciseData, RestoreExerciseResponses, RestoreEventData, RestoreEventResponses, ToggleAttendanceData, ToggleAttendanceResponses, DeleteAdministratorData, DeleteAdministratorResponses, PatchAdministratorData, PatchAdministratorResponses, RestoreAdministratorData, RestoreAdministratorResponses, FindTrainerByUserIdData, FindTrainerByUserIdResponses, GetStudentCommitmentsData, GetStudentCommitmentsResponses, GetCurrentCommitmentStatusData, GetCurrentCommitmentStatusResponses, GetCommitmentHistoryData, GetCommitmentHistoryResponses, GetCurrentActiveCommitmentsData, GetCurrentActiveCommitmentsResponses, GetAllSchedulesData, GetAllSchedulesResponses, GetSessionSeriesCommitmentsData, GetSessionSeriesCommitmentsResponses, GetReportsData, GetReportsResponses, DeletePlanData, DeletePlanResponses, GetPlanByIdData, GetPlanByIdResponses, GetCurrentStudentPlanData, GetCurrentStudentPlanResponses, GetExpiringSoonAssignmentsData, GetExpiringSoonAssignmentsResponses, GetAllActiveAssignmentsData, GetAllActiveAssignmentsResponses, GetTrainersForLookupData, GetTrainersForLookupResponses, GetStudentsForLookupData, GetStudentsForLookupResponses, GetAvailableSessionSeriesData, GetAvailableSessionSeriesResponses, FindAdministratorByUserIdData, FindAdministratorByUserIdResponses, FindAllPaginatedData, FindAllPaginatedResponses, RemoveSessionParticipantData, RemoveSessionParticipantResponses } from './types.gen';
...
export const restorePlan = <ThrowOnError extends boolean = false>(options: Options<RestorePlanData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RestorePlanResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getStudentPlanHistory = <ThrowOnError extends boolean = false>(options: Options<GetStudentPlanHistoryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetStudentPlanHistoryResponses, unknown, ThrowOnError>({
        ...
        url: '/plans/students/{studentId}/plans/assignments',
        ...options
    });
};
...
export const restoreTrainer = <ThrowOnError extends boolean = false>(options: Options<RestoreTrainerData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<RestoreTrainerResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getCurrentStudentPlan = <ThrowOnError extends boolean = false>(options: Options<GetCurrentStudentPlanData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetCurrentStudentPlanResponses, unknown, ThrowOnError>({
        ...
        url: '/plans/students/{studentId}/plans/assignments/current',
        ...options
    });
};
