...
export const updateExercise = <ThrowOnError extends boolean = false>(options: Options<UpdateExerciseData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<UpdateExerciseResponses, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
